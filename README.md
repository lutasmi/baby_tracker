...
- **Dos cortes que evitan mezclar cosas distintas**: un rato al pecho de menos de 5 minutos cuenta como **hidratación**, no como toma, porque sumarlo estropea el número que se mira para saber si toca; y un **pedete** no es una caca. Un biberón siempre es una toma, aunque se anotara sin hora de fin: lo que come es la cantidad, no el tiempo. El corte vale en todas partes: en los contadores, en el resumen de la cronología, en la evolución y en el "hace cuánto" —ni un consuelo de tres minutos reinicia el reloj de la última toma, ni unos gases el de la última caca—. Los minutos de pecho y los mililitros sí se suman siempre: se ha tomado, aunque fuera un rato.
...
- **Cronología** como línea de tiempo, con la hora a la izquierda y cabecera pegajosa por tramo. Se puede **filtrar por tipo** para seguir una sola cosa —cuántas veces ha comido, cómo ha dormido— sin el ruido de lo demás; el resumen de la cabecera sigue siendo el del tramo entero. "↓ Ver anteriores" encadena el tramo previo debajo sin perder de vista el actual, y "↑ Ver posteriores" hace lo propio hacia el presente cuando se está mirando el pasado; los huecos entre tomas se calculan de un tramo al siguiente. Dentro de cada tramo va **lo más reciente arriba**, igual que los tramos entre sí, y lo que venía de antes se ancla en su hora de fin y se coloca por ella.
