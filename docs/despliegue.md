...
- [ ] Abre esa URL y comprueba que la hoja **Baby Tracker** tiene una pestaña por tipo de registro (**Sueno**, **Tomas**, **Panales**, **Banos**, **Peso**, solo con cabeceras), más **Usuarios** (con tu email ya dado de alta) y **Bebe**. Guárdala en marcadores: es tu base de datos.
